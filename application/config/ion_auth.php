...
*/
$config['tables']['CONTACTO_U_ADMINISTRATIVA']           = 'CONTACTO_U_ADMINISTRATIVA';
$config['tables']['GRUPOS']          = 'GRUPOS';
$config['tables']['CONTACTOS_GRUPOS']    = 'CONTACTOS_GRUPOS';
 ...
 */
$config['join']['CONTACTO_U_ADMINISTRATIVA']  = 'CONTACTO_ID';
$config['join']['GRUPOS'] = 'GRUPO_ID';
 ...
 */
$config['site_title']                 = "Agenda Digital - Sistema de Administración de Proyectos";       // Site Title, example.com
$config['admin_email']                = "desarrolloweb@cultura.gob.mx"; // Admin Email, admin@example.com
$config['default_group']              = 'Registrado';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'VC_CORREO';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
