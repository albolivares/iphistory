...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => (isset($options['upload_dir'])) ? $options['upload_dir'] : dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
			'upload_url' => (isset($options['upload_url'])) ? $options['upload_url'] : $this->get_full_url().'/files/',            
