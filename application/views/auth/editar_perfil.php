...
<h1><?php echo lang('edit_user_perfil');?></h1>
<div class="row">
<div id="infoMessage"><?php echo $message;?></div>
<div class="col-md-12 col-sm-12 col-xs-12">
<div class="x_panel">
  <div class="x_title">
                    <h2><?php echo lang('edit_user_subheading_perfil');?></h2>
...
<?php echo form_open(uri_string(), 'class="form-horizontal form-label-left"');?>
      ...
      <div class="form-group col-md-6 col-sm-6 col-xs-12">
            ...
            foreach($u_administrativa as $v)
            {
              ...
              echo form_dropdown('id_u_administrativa', $options, $id_u_administrativa,array('class'=>'control-label col-md-7 col-sm-7 col-xs-12'));
?></div>
      </div>
       <div class="form-group col-md-6 col-sm-6 col-xs-12">
